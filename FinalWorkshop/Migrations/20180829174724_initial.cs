		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						name: "FK_VehiclePolicies_Customers_CustomerModelID",
						column: x => x.CustomerModelID,
						principalTable: "Customers",
						principalColumn: "ID",
						onDelete: ReferentialAction.Restrict);
					table.ForeignKey(
						name: "FK_VehiclePolicies_Vehicles_VehicleModelID",
			...
			migrationBuilder.CreateIndex(
				name: "IX_VehiclePolicies_CustomerModelID",
				table: "VehiclePolicies",
				column: "CustomerModelID");

			migrationBuilder.CreateIndex(
				name: "IX_VehiclePolicies_VehicleModelID",
				table: "VehiclePolicies",
